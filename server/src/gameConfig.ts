...
export const CONFIG = {
  ...
  // 이 시간 동안 전혀 나아가지 못한 사람은 '미참여'로 보고, 완주 판정에서 제외한다.
  // 손 놓고 있는 한 명 때문에 완주한 사람들이 계속 기다리는 일을 막는다.
  idleHumanMs: 25000,
  ...
  // 트랙 진행률(0~1) 기준 배치
  // 11개 → 7개 → **5개**. 7개도 간격이 2,250 units(약 4.5초)라 여전히 잦았다.
  // 이제 아이템 3 + 블록 2 = 5개, 간격 약 2,250~3,300 units(7~9초).
  itemBoxAt: [0.10, 0.43, 0.76],
  ipBlockAt: [0.27, 0.60],
  ...
  bombSpeed: 740,      // 카트 최고속(520)보다 빠르되 반응·회피 여유를 위해 소폭 하향(840→740)
